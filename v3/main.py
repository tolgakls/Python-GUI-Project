...
from canvas import Canvas, Port
...
class MainWindow(QWidget):
    ...
    def draw_input(self):
        ...
        tempClass.points = \
            [
             self.canvas.rectangle_begin + QtCore.QPoint(int(-self.canvas.Tri_In_H), int(self.canvas.Tri_In_F * tempClass.in_order)),
             self.canvas.rectangle_begin + QtCore.QPoint(0, int(self.canvas.Tri_In_F / 2 + self.canvas.Tri_In_F * tempClass.in_order)),
             self.canvas.rectangle_begin + QtCore.QPoint(int(-self.canvas.Tri_In_H), int(self.canvas.Tri_In_F + self.canvas.Tri_In_F * tempClass.in_order))
            ]
    ...
    def draw_output(self):
        ...
        tempClass.points = [self.canvas.rectangle_end + QtCore.QPoint(self.canvas.Tri_In_H, int(-self.canvas.Tri_In_F / 2 - self.canvas.Tri_In_F * tempClass.out_order)),
                    self.canvas.rectangle_end + QtCore.QPoint(0, int(-self.canvas.Tri_In_F - self.canvas.Tri_In_F * tempClass.out_order)),
                    self.canvas.rectangle_end + QtCore.QPoint(0, int(- self.canvas.Tri_In_F * tempClass.out_order))]
        tempClass.set_polygon()
    ...
    def draw_inout(self):
        ...
        tempClass.points = [self.canvas.rectangle_begin + QtCore.QPoint(int(-self.canvas.Tri_In_H), int(self.canvas.Tri_In_F * tempClass.in_order)),
                    self.canvas.rectangle_begin + QtCore.QPoint(0, int(self.canvas.Tri_In_F / 2 + self.canvas.Tri_In_F * tempClass.in_order)),
                    self.canvas.rectangle_begin + QtCore.QPoint(int(-self.canvas.Tri_In_H), int(self.canvas.Tri_In_F + self.canvas.Tri_In_F * tempClass.in_order)),
                    self.canvas.rectangle_begin + QtCore.QPoint(int(-2*self.canvas.Tri_In_H), int(self.canvas.Tri_In_F / 2 + self.canvas.Tri_In_F * tempClass.in_order))]
        tempClass.set_polygon()
        tempClass.in_order = self.in_order
        self.in_order = self.in_order + 1
